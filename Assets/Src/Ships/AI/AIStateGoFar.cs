...
public class AIStateGoFar : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        m_hActor.Rigidbody.AddForce((m_hActor.Transform.position - m_hActor.Target.Transform.position).normalized * m_hActor.EngineForce);
    }
